...
public class OracleDBConfig {
	...
	public LocalContainerEntityManagerFactoryBean createOraEMF(EntityManagerFactoryBuilder builder) {
		//prepare Oracle Hibenate Properties
		Map<String, String> props=new HashMap<String, String>();
		props.put("hibenate.dialect","org.hibernate.dialect.OracleDialect");
		props.put("hibernate.hbm2ddl.auto","update");
		props.put("hibernate.show_sql","true");
		//create and return LocalContainerEntityManagerFactoryBean class obj which
